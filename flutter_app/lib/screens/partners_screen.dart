...
class _PartnersScreenState extends State<PartnersScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_loadError && _partners.isEmpty) {
      return Scaffold(
        appBar: AppBar(backgroundColor: VionaColors.background, title: const Text('Partners')),
        body: Center(
          child: Column(
            ...
            children: [
              ...
              const Text('Could not load partners', style: TextStyle(color: VionaColors.textSecondary)),
